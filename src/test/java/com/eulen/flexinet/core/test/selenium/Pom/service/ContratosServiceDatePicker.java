...
public class ContratosServiceDatePicker extends BasePage {

    private PageLocators pageLocators;
    private HomePageLocators homePageLocators;
    private CommonService commonService;

    public ContratosServiceDatePicker(WebDriver driver) {
        super(driver);
    ...
    public void pickDateFechaDeInicioDesde(String scn, SystemPages page, PanelTitle panelTitle, String file, Integer cajaNumero, boolean isRequired, boolean waitForSpinner, boolean checkNoMessageShown) throws Exception {
        ...
        switch (page){
            ...
            case CONTRATOS__CONTROL_ENVIOS_CPDS:
                datos = datosContrato.getContratosControlEnviosCpds().getFechadeInicioDesde();
                break;
        }
        commonService.datePickerField( scn, panelTitle, FieldByTagLabelText.DATE_FECHAINICIODESDE, cajaNumero, datos, isRequired, waitForSpinner, checkNoMessageShown );
    }
    ...
    public void pickDateInicioHasta(String scn, SystemPages page, PanelTitle panelTitle, String file, Integer cajaNumero, boolean isRequired, boolean waitForSpinner, boolean checkNoMessageShown) throws Exception{
        ...
        commonService.datePickerField( scn, panelTitle, FieldByTagLabelText.HASTA, cajaNumero, datos, isRequired, waitForSpinner, checkNoMessageShown );
    }
    ...
    public void pickDateFinHasta(String scn, SystemPages page, PanelTitle panelTitle, String file, Integer cajaNumero, boolean isRequired, boolean waitForSpinner, boolean checkNoMessageShown) throws Exception{
        ...
        switch (page) {
            case CONTRATOS__BAJA_CONSULTA:
                datos = datosContrato.getContratosBajaConsulta().getFechaDeFinHasta();
                break;
            case CONTRATOS__BAJA_BAJAS_MASIVAS:
    ...
    public void pickDateBajaContrato(String scn, SystemPages page, PanelTitle panelTitle, String file, Integer cajaNumero, boolean isRequired, boolean waitForSpinner, boolean checkNoMessageShown) throws Exception{
        commonService.datePickerField( scn, panelTitle, FieldByTagLabelText.DATE_FECHABAJA, cajaNumero, datosContrato.getContratosNovacionAlta().getDialogAltaNovacion().getFecha(), isRequired, waitForSpinner, checkNoMessageShown );
    }
    ...
    public void pickDateBaja(String scn, SystemPages page, PanelTitle panelTitle, String file, Integer cajaNumero, boolean isRequired, boolean waitForSpinner, boolean checkNoMessageShown) throws Exception{
        ...
        commonService.datePickerField( scn, panelTitle, FieldByTagLabelText.FECHA, cajaNumero, datos, isRequired, waitForSpinner, checkNoMessageShown );
    }
    public void pickFechaEnvioCpdsProrrogas(String scn, SystemPages page, PanelTitle panelTitle, String file, Integer cajaNumero, boolean isRequired, boolean waitForSpinner, boolean checkNoMessageShown) throws Exception{
        jsonFileNew(file);
        String datos = "";
        switch (page) {
            case CONTRATOS__CONTROL_ENVIOS_CPDS:
                datos = datosContrato.getContratosControlEnviosCpds().getDialogFechaEnvioCpds().getFecha();
                break;
        }
        commonService.datePickerField( scn, panelTitle, FieldByTagLabelText.INTRODUCIR_FECHA, cajaNumero, datos, isRequired, waitForSpinner, checkNoMessageShown );
    }
    ...
    public void pickDateFechaDeInicioHasta(String scn, SystemPages page, PanelTitle panelTitle, String file, Integer cajaNumero, boolean isRequired, boolean waitForSpinner, boolean checkNoMessageShown) throws Exception {
        ...
        switch (page){
            ...
            case CONTRATOS__PRORROGAS_ANULACION:
                ...
                break;
            case CONTRATOS__CONTROL_ENVIOS_CPDS:
                datos = datosContrato.getContratosControlEnviosCpds().getFechadeInicioHasta();
                break;
        }
        commonService.datePickerField( scn, panelTitle, FieldByTagLabelText.DATE_FECHAINICIOHASTA, cajaNumero, datos, isRequired, waitForSpinner, checkNoMessageShown );
    }
    ...
    public void pickDateFechaFinalizacionProrroga(String scn, @NotNull SystemPages page, PanelTitle panelTitle, String file, Integer cajaNumero, boolean isRequired, boolean waitForSpinner, boolean checkNoMessageShown) throws Exception{
        ...
        commonService.datePickerField( scn, PanelTitle.DIALOG_CREACIONPRORROGA, FieldByTagLabelText.DATE_FECHAFINALIZACIONPRORROGA, cajaNumero, datos, isRequired, waitForSpinner, checkNoMessageShown );
    }
    ...
    public void pickDateFechaDeFinDesde(String scn, SystemPages page, PanelTitle panelTitle, String file, Integer cajaNumero, boolean isRequired, boolean waitForSpinner, boolean checkNoMessageShown) throws Exception {
        ...
        switch (page){
            ...
            case CONTRATOS__PRORROGAS_ANULACION:
                ...
                break;
            case CONTRATOS__CONTROL_ENVIOS_CPDS:
                datos = datosContrato.getContratosControlEnviosCpds().getFechaDeFinDesde();
                break;
        }
        commonService.datePickerField( scn, panelTitle, FieldByTagLabelText.DATE_FECHAFINDESDE, cajaNumero, datos, isRequired, waitForSpinner, checkNoMessageShown );
    }
    ...
    public void pickDateFechaDeFinHasta(String scn, SystemPages page, PanelTitle panelTitle, String file, Integer cajaNumero, boolean isRequired, boolean waitForSpinner, boolean checkNoMessageShown) throws Exception {
        ...
        switch (page){
            ...
            case CONTRATOS__PRORROGAS_ANULACION:
                ...
                break;
            case CONTRATOS__CONTROL_ENVIOS_CPDS:
                datos = datosContrato.getContratosControlEnviosCpds().getFechaDeFinHasta();
                break;
        }
        commonService.datePickerField( scn, panelTitle, FieldByTagLabelText.DATE_FECHAFINHASTA, cajaNumero, datos, isRequired, waitForSpinner, checkNoMessageShown );
    }

    public void pickDateInicioDeLaSustitucion(String scn, SystemPages page, PanelTitle panelTitle, String file, Integer cajaNumero, boolean isRequired, boolean waitForSpinner, boolean checkNoMessageShown) throws Exception{
        jsonFileNew(file);
        String datos = datosContrato.getContratoAltaSustitucion().getFechaInicioSustitucion();

        commonService.datePickerField( scn, panelTitle, FieldByTagLabelText.DATE_FECHAINICIOSUSTITUCION, cajaNumero, datos, isRequired, waitForSpinner, checkNoMessageShown );
    }
}
